...
- `video-note-render-pdf-v0` -> `WncFht/video-note-pipeline` + repo-local `.local/workspaces/video-notes` workspace
- `video-note-render-pdf-v1` -> `WncFht/video-note-pipeline` + repo-local `.local/workspaces/video-notes` workspace
